...
import fantasy.domain.GameDataOnDemand;
...
privileged aspect GameIntegrationTest_Roo_IntegrationTest {
    ...
    public void GameIntegrationTest.testCountGames() {
        ...
        long count = fantasy.domain.Game.countGames();
    ...
    public void GameIntegrationTest.testFindGame() {
        fantasy.domain.Game obj = dod.getRandomGame();
        ...
        obj = fantasy.domain.Game.findGame(id);
    ...
    public void GameIntegrationTest.testFindAllGames() {
        ...
        java.util.List<fantasy.domain.Game> result = fantasy.domain.Game.findAllGames();
    ...
    public void GameIntegrationTest.testFindGameEntries() {
        ...
        java.util.List<fantasy.domain.Game> result = fantasy.domain.Game.findGameEntries(0, (int) count);
    ...
    public void GameIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyGame(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        fantasy.domain.Game merged =  obj.merge();
        obj.flush();
    ...
    public void GameIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Game' failed to initialize correctly", dod.getRandomGame());
        fantasy.domain.Game obj = dod.getNewTransientGame(Integer.MAX_VALUE);
    ...
    public void GameIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Game' with identifier '" + id + "'", fantasy.domain.Game.findGame(id));
    }
