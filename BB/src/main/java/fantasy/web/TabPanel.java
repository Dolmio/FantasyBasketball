	...
	public TabPanel() {
		...
		tabSheet.addListener(new SelectedTabChangeListener() {
			...
			public void selectedTabChange(SelectedTabChangeEvent event) {
				...
				if(tabSheet.getSelectedTab() instanceof TeamsView){
					teamsView_1.updateTeamsView();
				}
				else if(tabSheet.getSelectedTab() instanceof OwnTeamView){
					ownTeamView.updateOwnTeamView();
				}
				else if(tabSheet.getSelectedTab() instanceof PlayersView){
					playersView_1.updatePlayersView();
				}
				else if(tabSheet.getSelectedTab() instanceof ResultsView){
					resultsView_1.updateResultsView();
				}
				else if(tabSheet.getSelectedTab() instanceof UpdateView){
					updateView.updateUpdateView();
				}
				
				else if(tabSheet.getSelectedTab() instanceof StandingsView){
					standingsView.updateStandingsView();
				}
				
				else if(tabSheet.getSelectedTab() instanceof NewsView){
					newsView.updateNewsView();
				}
				
				else if(tabSheet.getSelectedTab() instanceof RulesView){
