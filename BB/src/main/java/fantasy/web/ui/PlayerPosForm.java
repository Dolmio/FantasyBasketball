 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = fantasy.domain.PlayerPos.class)
public class PlayerPosForm extends CustomComponent implements EntityEditor {
    ...
    @AutoGenerated
    private ComboBox playerPositionField;
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // playerPositionField
        playerPositionField = new ComboBox();
        playerPositionField.setWidth("-1px");
        playerPositionField.setHeight("-1px");
        playerPositionField.setCaption("Player Position");
        playerPositionField.setImmediate(true);
        fieldLayout.addComponent(playerPositionField);
