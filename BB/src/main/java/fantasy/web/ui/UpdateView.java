...
public class UpdateView extends CustomComponent implements ContentUpdateable{
	...
	@AutoGenerated
	private Button roundTotalUpdateButton;
	@AutoGenerated
	private Select roundSelect;
	@AutoGenerated
	private Button updatePlayerStatsButton;
	@AutoGenerated
	...
	private VerticalLayout buildMainLayout() {
		...
		// updateButton
		updatePlayerStatsButton = new Button();
		updatePlayerStatsButton.setCaption("Update player stats");
		updatePlayerStatsButton.setImmediate(true);
		updatePlayerStatsButton.setWidth("-1px");
		updatePlayerStatsButton.setHeight("-1px");
		mainLayout.addComponent(updatePlayerStatsButton);
		mainLayout.setComponentAlignment(updatePlayerStatsButton, new Alignment(20));
		...
		// roundUpdateButton
		roundTotalUpdateButton = new Button();
		roundTotalUpdateButton.setCaption("Update League Points in Round");
		roundTotalUpdateButton.setImmediate(true);
		roundTotalUpdateButton.setWidth("-1px");
		roundTotalUpdateButton.setHeight("-1px");
		mainLayout.addComponent(roundTotalUpdateButton);
		mainLayout.setComponentAlignment(roundTotalUpdateButton, new Alignment(20));
