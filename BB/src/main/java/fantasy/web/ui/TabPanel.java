...
public class TabPanel extends CustomComponent {
			...
			public void selectedTabChange(SelectedTabChangeEvent event) {
				...
				if(tabSheet.getSelectedTab() instanceof ContentUpdateable){
					...
					if(currentRole != Role.VISITOR){
						...
						tabSheet.getTab(loginForm).setCaption("Kirjaudu");
						refreshRoleTabs();
	...
	public void refreshAfterLogin(){
		refreshRoleTabs();
		tabSheet.setSelectedTab(standingsView);
		tabSheet.getTab(loginForm).setCaption("Kirjaudu ulos");
	}
	...
	private TabSheet buildTabSheet() {
		...
		tabSheet.addTab(standingsView, "Sarjataulukko", null);
		...
		tabSheet.addTab(teamsView_1, "Joukkueet", null);
		...
		tabSheet.addTab(ownTeamView, "Joukkueeni", null);
		...
		tabSheet.addTab(playersView_1, "Pelaajat", null);
		...
		tabSheet.addTab(updateView, "Päivitä", null);
		...
		tabSheet.addTab(loginForm, "Kirjaudu", null);
