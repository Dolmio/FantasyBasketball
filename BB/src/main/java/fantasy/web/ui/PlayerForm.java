 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = fantasy.domain.Player.class)
public class PlayerForm extends CustomComponent implements EntityEditor {
    ...
    @AutoGenerated
    private TwinColSelect possiblePositionsField;
    @AutoGenerated
    private ComboBox currentPositionField;
    @AutoGenerated
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // possiblePositionsField
        possiblePositionsField = new TwinColSelect();
        possiblePositionsField.setWidth("-1px");
        possiblePositionsField.setHeight("-1px");
        possiblePositionsField.setCaption("Possible Positions");
        possiblePositionsField.setImmediate(true);
        fieldLayout.addComponent(possiblePositionsField);

        // currentPositionField
        currentPositionField = new ComboBox();
        currentPositionField.setWidth("-1px");
        currentPositionField.setHeight("-1px");
        currentPositionField.setCaption("Current Position");
        currentPositionField.setImmediate(true);
        fieldLayout.addComponent(currentPositionField);

        // teamField
        teamField = new ComboBox();
        teamField.setWidth("-1px");
        teamField.setHeight("-1px");
        teamField.setCaption("Team");
        teamField.setImmediate(true);
        fieldLayout.addComponent(teamField);
